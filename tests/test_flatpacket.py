...
def test_flatpacket_from_buffer():
    ...
    frame_bytes = (b"\x01\x00\x00\x00\x00\x00\x00\x00\x90\x00\x00\x00\x00\x00"
                   b"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                   b"\x00\x00\x00\x008\x00\x00\x00\x00\x00\x00\x00F5C71FCC-8B"
                   b"80-4C2E-BD78-7F669E9591AA\x00\x00\x00\x00\x00\x00\x00"
                   b"\x00\x005\x00\x00\x00\x00\x00\x00\x00foo")
    fpkt_bytes = (b"F5C71FCC-8B80-4C2E-BD78-7F669E9591AA\x00\x00\x00\x00\x00"
                  b"\x00\x00\x00\x005\x00\x00\x00\x00\x00\x00\x00foo")
